...
import sloganImageSrc from './icons/slogan.png';
...
<template>
  ...
  >
    ...
    <div v-if="logo || appName" class="absolute left-0 top-0 z-10 flex flex-1">
      ...
      >
        <img v-if="logo" :alt="appName" :src="logo" class="mr-2" width="45" />
        ...
        <div class="flex-col-center -enter-x mr-20 h-full">
          <template v-if="sloganImage">
            <img
              :alt="appName"
              :src="sloganImage"
              class="animate-float object-contain"
